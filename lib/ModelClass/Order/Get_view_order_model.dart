...
class GetViewOrderModel {
  GetViewOrderModel({bool? success, Data? data, ErrorResponse? errorResponse}) {
    _success = success;
    _data = data;
  }
  ...
  GetViewOrderModel copyWith({bool? success, Data? data}) =>
      GetViewOrderModel(success: success ?? _success, data: data ?? _data);
